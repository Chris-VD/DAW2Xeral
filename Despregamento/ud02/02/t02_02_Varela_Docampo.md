#### Exercicio 1: Reprodución de contorno de desenvolvemento con Composer

> O ideal sería realizar esta mesma tarefa noutra máquina. Pero  teríamos que refacer toda a configuración e volver a instalar PHP e `Composer`. Polo tanto o único que vamos a realizar é borrar os repositorios que  hai máquina virtual. Se queres facer unha nova máquina que teña por nome `dapw_iniciais_server_01b` e como nome interno da máquina `iniciais_server_01b`.
...
2. Comproba que non temos o directorio `vendor`. **Realiza unha captura** desta comprobación.
   ...
   ![image](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/02/1/image.png)
...
4. **Realiza unha captura** do contido do directorio `vendor`.
   ...
   ![image copy](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/02/1/image copy.png)
...
2. Modifica o ficheiro `composer.json` para que instale unha versión concreta dos paquetes instalados. **Realiza unha captura** do contido deste ficheiro.
   ...
   ![image copy 2](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/02/1/image copy 2.png)
...
5. Executa o *script* co seguinte comando `php xerar_alumnos.php` para ver que todo funciona correctamente. **Realiza unha captura** do ficheiro creado por este *script*.
   ...
   ![out](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/02/1/out.png)
...
2. Na parte dereita da web, poderedes observar as versións dispoñibles. Instala a penúltima versión. **Realiza unha captura** do comando utilizado para realizar esta instalación. Recorda utilizar a opción `--dev` para que só se instale nun contorno de desenvolvemento.
   ...
   ![image copy 3](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/02/1/image copy 3.png)

3. **Realiza unha captura** do contido do contido do ficheiro `composer.json`.

   ![image copy 4](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/02/1/image copy 4.png)
...
5. **Realiza unha captura** do repositorio en GitLab.com que se vexa o contido deste.
   ...
   ![image copy 5](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/02/1/image copy 5.png)
...
2. Comproba que non temos o directorio `node_modules`. **Realiza unha captura** desta comprobación.
   ...
   ![image](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/02/02/image.png)
...
4. **Realiza unha captura** do contido do directorio `node_modules`.
   ...
   ![image copy](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/02/02/image copy.png)
...
2. Modifica o ficheiro `package.json` para que se instale unha versión concreta. **Realiza unha captura** do contido deste ficheiro.
   ...
   ![image copy 2](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/02/02/image copy 2.png)
...
4. Executa o comando `node index.js` para ver que todo funciona correctamente. **Realiza capturas** da saída da execución do *script*.
   ...
   ![image copy 3](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/02/02/image copy 3.png)
...
2. Instala a penúltima versión do paquete en modo desenvolvemento. **Realiza captura** do comando utilizado.
   ...
   ![image copy 4](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/02/02/image copy 4.png)

3. **Realiza unha captura** do contido do ficheiro `packages.json`.

   ![image copy 5](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/02/02/image copy 5.png)

4. Realiza un `commit` e un `push` para subir o repositorio a GitLab.com.

5. **Realiza unha captura** do repositorio en GitLab.com que se vexa o contido deste.

   ![image copy 6](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/02/02/image copy 6.png)