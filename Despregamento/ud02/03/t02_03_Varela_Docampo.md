...
3. Proba dende o terminal da propia máquina virtual a conexión a base de datos. **Realiza capturas** do correcto inicio de sesión con este usuario.
   ...
   ![image](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/03/01/image.png)
...
4. Preme en `Add New Connection` e realiza a conexión. **Realiza capturas** da configuración que realizas para a conexión. Podes probar se está todo correcto premendo en `Test Connection` (para iso pedirá o contrasinal do usuario). Deberás indicar os seguintes datos:
   ...
   - En `usernmae` o nome de usuario de desenvolvemento con acceso a base de datos.
     ...
     ![image](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/03/02/image.png)
...
12. **Realiza unha captura** do contido da táboa.
    ...
    ![image copy](/home/sanclemente.local/a24christianvd/Documentos/Despregamento/ud02/03/02/image copy.png)
